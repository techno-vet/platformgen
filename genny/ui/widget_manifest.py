"""
widget_manifest.py — Genny Widget AI Manifest Loader

Two-tier knowledge architecture:
  1. Static tier  — genny/data/widget_manifests.yaml  (git-committed, describes all widgets)
  2. Learned tier — ~/.genny/widget_knowledge/{widget_name}.yaml  (runtime discoveries by Auger)

Usage:
    from genny.ui.widget_manifest import build_manifest_context, save_learned
...
_STATIC_CANDIDATES = [
    ...
    Path("/home/auger/repos/platformgen/genny/data/widget_manifests.yaml"),
...
LEARNED_DIR = Path.home() / ".genny" / "widget_knowledge"
