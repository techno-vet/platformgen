...
from genny.ui.help_docs import all_docs as _all_docs
...
class HelpViewerWidget(tk.Frame):
    ...
    def _create_ui(self):
        ...
        tk.Label(hdr, text="  Tip: Ask Genny anything — just type in the chat below",
    ...
    def _make_splash(self) -> tk.Frame:
        ...
        tk.Label(f,
                 text="Select a topic from the Help menu  or  Widgets → Help\n\n"
                      "Or just Ask Genny — type your question in the chat below.",
