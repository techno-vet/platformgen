...
from genny.tools.cryptkeeper_lite import encrypt_value, decrypt_value, decrypt_file as decrypt_file_tool
...
class CryptkeeperLiteWidget(tk.Frame):
    ...
    def _encrypt_value(self, key, value):
        """Encrypt a value using genny.tools.cryptkeeper_lite"""
    ...
    def _decrypt_value(self, key, value):
        """Decrypt a value using genny.tools.cryptkeeper_lite"""
