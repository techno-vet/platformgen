...
try:
    from genny.tools.stakeholder_mention import mention_on_block
except ImportError:
...
FLUX_CACHE_DIR = Path.home() / '.genny' / 'flux_cache'
...
class StoryToProdWidget(tk.Frame):
    ...
    def _build_dev_panel(self):
        """Dev Deploy stage: Genny deploys to Dev namespace, developer validates. Loop B."""
        f = self._dev_frame
        ...
        self._dev_text.tag_config('genny',   foreground=BLUE)
    ...
    def _render_jira(self, data):
        ...
        self._dev_log(f'\n  💻 Genny will handle: branch detection, image promotion, Flux PR\n', 'genny')
    ...
    def _do_create_flux_pr(self, story_key, env_label, repo_name, path_part, services, images):
        try:
            ...
            pr_body = (
                ...
                'Created by Genny Story→Prod pipeline.\n\n'
                'Co-authored-by: Copilot <223556219+Copilot@users.noreply.github.com>'
            )
