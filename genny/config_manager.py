...
class GennyConfigManager:
    """Manages Genny configuration with defaults, user config, and env vars"""
    
    def __init__(self, config_dir: Optional[Path] = None):
        """Initialize config manager
        
        Args:
            config_dir: Custom config directory (default: ~/.genny)
        """
        self.config_dir = config_dir or Path.home() / '.genny'
