...
ACTIVATION_SOCKET = Path.home() / ".auger" / "platform-activate.sock"
...
class AugerSREPlatform(tk.Tk):
    ...
    def __init__(self):
        super().__init__(className="auger-platform")
        
        self.title("Auger — AI SRE Platform")
        ...
        try:
            ...
            # Use a user-specific path to avoid root-owned /tmp/auger_icon.png conflicts
            _icon_tmp = os.path.join(os.path.expanduser("~/.auger"), "auger_icon.png")
